 ...
 * @generated
 */
public class MbrpSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case MbrpPackage.FUNCTIONAL_REQUIREMENT: {
			...
			if (result == null)
				result = caseRequirement(functionalRequirement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case MbrpPackage.NON_FUNCTIONAL_REQUIREMENT: {
			...
			if (result == null)
				result = caseRequirement(nonFunctionalRequirement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case MbrpPackage.SECURITY_REQUIREMENT: {
			...
			if (result == null)
				result = caseNonFunctionalRequirement(securityRequirement);
			if (result == null)
				result = caseRequirement(securityRequirement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case MbrpPackage.PERFORMANCE_REQUIREMENT: {
			...
			if (result == null)
				result = caseNonFunctionalRequirement(performanceRequirement);
			if (result == null)
				result = caseRequirement(performanceRequirement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case MbrpPackage.SAFETY_REQUIREMENT: {
			...
			if (result == null)
				result = caseNonFunctionalRequirement(safetyRequirement);
			if (result == null)
				result = caseRequirement(safetyRequirement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case MbrpPackage.ROBUSTNESS_REQUIREMENT: {
			RobustnessRequirement robustnessRequirement = (RobustnessRequirement) theEObject;
			T result = caseRobustnessRequirement(robustnessRequirement);
			if (result == null)
				result = caseNonFunctionalRequirement(robustnessRequirement);
			if (result == null)
				result = caseRequirement(robustnessRequirement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Robustness Requirement</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Robustness Requirement</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRobustnessRequirement(RobustnessRequirement object) {
		return null;
	}
